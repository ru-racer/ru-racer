...
plot3(T(10:end),out(end,10:end),z(6,10:end)/2,'Parent',ax_phase,'LineWidth',2,'DisplayName','Proposed','Color',[0 0 0],'LineStyle','-');
hold on
...
if stability_bound_cost(out(end,i),z(6,i)/2,0)>0
    plot3(T(i),out(end,i),z(6,i)/2,'*r');
end
