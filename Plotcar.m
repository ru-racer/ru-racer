function Plotcar(Z,del,l,b,lstyle,color)
...
plot(wheel1(1,:),wheel1(2,:),'Color',color,'LineStyle',lstyle,'LineWidth',4)
plot(wheel2(1,:),wheel2(2,:),'Color',color,'LineStyle',lstyle,'LineWidth',4)
plot(wheel3(1,:),wheel3(2,:),'Color',color,'LineStyle',lstyle,'LineWidth',4)
plot(wheel4(1,:),wheel4(2,:),'Color',color,'LineStyle',lstyle,'LineWidth',4)
...
fill([x1(1) x2(1) x3(1)],[x1(2) x2(2) x3(2)],[1 1 0]);
